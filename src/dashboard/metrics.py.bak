...
def calculate_global_metrics(df, target='trip_score_6_weeks', model_col='model_type'):
    """
...
def calculate_oll_success_rate(df_oll):
    """
...
def get_segment_lift(df, segment_col, target='trip_score_6_weeks', model_col='model_type'):
    """
